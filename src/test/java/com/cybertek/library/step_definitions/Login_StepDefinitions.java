...
public class Login_StepDefinitions {
    ...
    public void i_am_on_the_login_page() {
        String url = ConfigurationReader.getProperty("qa3_url");
    ...
    public void there_should_be_users(Integer int1) {
        int expectedUserNumber = int1; //818
    ...
    public void accountHolderNameShouldBe(String expectedAccountUsername) {
       ...
       wait.until(ExpectedConditions.visibilityOf(landingPage.accountUsername));
